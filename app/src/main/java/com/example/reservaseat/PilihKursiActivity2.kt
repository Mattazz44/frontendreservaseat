...
class PilihKursiActivity2 : AppCompatActivity() {

    private var selectedSeat: TextView? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pilih_kursi_jambu_dua)
        ...
        // Tombol Lanjutkan — navigasi ke IsiDataActivity2
        findViewById<Button>(R.id.btnLanjutkan).setOnClickListener {
            if (selectedSeat == null) {
                ...
                val intent = Intent(this, IsiDataActivity2::class.java)
