...
class FeedbackActivity_jambu_dua : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_feedback_jambu_dua)
        ...
        star5_fb2.setColorFilter(Color.parseColor("#E0E0E0")) // Bintang abu-abu
    }
}