...
class PembayaranGagalJambu : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pembayaran_gagal_jambu_dua)

        supportActionBar?.hide()

        val btnBackHeader = findViewById<ImageView>(R.id.btnBackHeader)
        val btnCobaLagi = findViewById<Button>(R.id.btnCobaLagi2)
